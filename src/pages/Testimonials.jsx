...
const testimonials = [
  { name: "Rajesh Kumar", role: "CEO, TechVision Solutions", initials: "RK", text: `Rama & Rama has been protecting our corporate office for over 3 years. Their employees are professional, well-trained, and always alert.` },
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="bg-[#0b2b7a] text-white py-16 px-6 md:px-12 scroll-mt-24">
