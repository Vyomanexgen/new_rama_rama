...
export default function WhyUs() {
  return (
    <section id="whyus" className="py-16 bg-gray-50 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="w-full bg-gradient-to-r from-[#1a3b9c] to-[#1742e5] text-center py-16 px-4 rounded-2xl shadow-lg mt-16">
          ...
          <a
            href="/#contact"
            className="bg-[#f2b705] hover:bg-[#e0a800] text-black font-medium py-3 px-8 rounded-md text-lg inline-block"
          >
