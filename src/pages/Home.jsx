...
const Home = () => {
  ...
  return (
    <main>
      <section id="home" className="relative w-full min-h-[85vh] overflow-hidden scroll-mt-24">
        {slides.map((s, i) => (
          <div key={s.id} className={`absolute inset-0 transition-opacity duration-1000 ${i === current ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
            ...
            <div className="relative z-20 px-6 md:px-16 lg:px-32 h-full flex items-center">
              <div className="max-w-3xl text-white">
                ...
                <a href="/#contact" className="inline-block bg-white text-[#0b2b7a] px-6 py-3 rounded-lg font-medium">
                  Contact Now
                </a>
              </div>
            </div>
