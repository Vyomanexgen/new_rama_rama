...
export default function Notifications({ value, onSave, saving }) {
  ...
  return (
    <div className="text-slate-700">
      <div className="flex items-start gap-3 mb-6">
        <div className="text-green-600 bg-green-100 p-2 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14 10V6a4 4 0 00-8 0v4a2 2 0 01-.73 1.53L4 13h12l-1.27-1.47A2 2 0 0114 10zm-7 6a3 3 0 006 0H7z" />
          </svg>
        </div>

        <div>
          <h2 className="text-2xl font-semibold">Notification Preferences</h2>
          <p className="text-gray-500 mt-1">Configure how you receive system notifications</p>
        </div>
      </div>

      <div className="bg-white border rounded-xl shadow-sm p-6 mb-6">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">Notification Channels</h3>
      ...
      <div className="bg-white border rounded-xl shadow-sm p-6 mb-6">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">Event Notifications</h3>
      ...
      <div className="bg-white border rounded-xl shadow-sm p-6 mb-6">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">Report Notifications</h3>
...
function NotificationRow({ title, desc, enabled, onClick }) {
  return (
    <div className="flex items-center justify-between pb-4 border-b last:border-none">
      ...
      <button
        onClick={onClick}
        className={`w-12 h-6 rounded-full flex items-center transition-all px-1 ${enabled ? "bg-indigo-600 justify-end" : "bg-gray-300 justify-start"}`}
      >
