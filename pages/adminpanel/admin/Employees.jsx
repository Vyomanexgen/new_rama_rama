...
const Employees = () => {
  const [employees] = useState([
    { id: 1, name: "Rajesh Kumar", email: "rajesh@ramarama.com", role: "Employee", dept: "Corporate", status: "Active" },
    { id: 2, name: "Priya Sharma", email: "priya@ramarama.com", role: "Employee", dept: "Residential", status: "Active" },
    { id: 3, name: "Amit Patel", email: "amit@ramarama.com", role: "Employee", dept: "Corporate", status: "Active" },
    { id: 4, name: "Sunita Singh", email: "sunita@ramarama.com", role: "Employee", dept: "Residential", status: "Inactive" },
  ]);
            ...
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="e.g., Employee"
                    className="w-full bg-gray-100 border rounded-lg p-3 mt-1" />
                </div>
                <div>
